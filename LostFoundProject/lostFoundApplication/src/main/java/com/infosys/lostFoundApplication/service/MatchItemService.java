...
public class MatchItemService {
	...
	public void updateLostFoundItems(MatchItem matchItem) {
		String lostItemId= matchItem.getMatchItemId().getLostItemId();
		String foundItemId= matchItem.getMatchItemId().getFoundItemId();
